                ...
                <div className="flex w-full items-center space-x-2">
                    ...
                    {isConnected ? (
                        <>
                         ...
                         <Button onClick={() => joinRoom()} disabled={isConnecting} className="rounded-full font-semibold px-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white shadow-lg hover:scale-105 transition-transform shrink-0">
