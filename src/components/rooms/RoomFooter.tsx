...
import { Mic, MicOff, Settings, Loader2, Gamepad2, Gift, Volume2, VolumeX, PhoneOff, MoreHorizontal } from 'lucide-react';
                                ...
                                {canJoinToSpeak && (
                                    <>
                                        {isConnected ? (
                                             ...
                                             <Button onClick={() => joinVoice({ muted: true })} disabled={isConnecting} className="rounded-full font-semibold px-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-lg hover:scale-105 transition-transform shrink-0">
