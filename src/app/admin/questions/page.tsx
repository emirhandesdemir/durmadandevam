                ...
                <CardHeader className="flex-row items-start gap-4">
                    ...
                    <div>
                        ...
                        <CardDescription className="text-blue-800 dark:text-blue-300">
                            Bu özellik artık tamamen yapay zeka tarafından yönetilmektedir. Sistem, oyun zamanı geldiğinde otomatik olarak internetten güncel, çeşitli ve eğlenceli trivia soruları bularak oyunu kendi kendine başlatır. Bu sayede manuel olarak soru eklemenize veya yönetmenize gerek kalmamıştır.
                        </CardDescription>
                    </div>
                </CardHeader>
            </Card>
